...
Source Data
The data for tidydata.txt is derived from source data: The UCI Machine Learning Repository [http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones] here  
